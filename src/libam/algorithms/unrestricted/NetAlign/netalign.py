...
class NetAlign(AlignAlgorithm):
    ...
    def _align(self) -> np.ndarray | torch.Tensor | scipy.sparse.csr_matrix:
        ...
        fbest = 0
        fbestiter = 0
        logging.getLogger(__name__).debug('{:4s}   {:>4s}   {:>7s} {:>7s} {:>7s} {:>7s}   {:>7s} {:>7s} {:>7s} {:>7s}'.format(
        ...
        for it in range(1, self.max_iter + 1):
            ...
            if fbestiter == it:
                ...
                bestchar = ''
            logging.getLogger(__name__).debug('{:4s}   {:4d}   {:7.2f} {:7.2f} {:7d} {:7d}   {:7.2f} {:7.2f} {:7d} {:7d}'.format(
