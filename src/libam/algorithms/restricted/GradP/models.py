...
class GradAlign:
    def __init__(self, G1, G2, att_s, att_t, att_aug_s, att_aug_t, k_hop, hid, alignment_dict, alignment_dict_reversed,
                 train_ratio, idx1_dict, idx2_dict, anchors_GQ, anchors_G, alpha, beta):
        ...
        while True:
            ...
            if iteration == 0:
                ...
                embedding1, embedding2 = self.embedding(seed_list1, seed_list2, iteration, self.epochs, x_s,
                                                        ...
                                                        model, data_s, data_t)
                embedding_aug1, embedding_aug2 = self.embedding(seed_list1, seed_list2, iteration, self.epochs, x_aug_s,
                                                                edge_index_aug_s,
                                                                edge_weight_aug_s, x_aug_t, edge_index_aug_t,
                                                                edge_weight_aug_t, model_aug, data_aug_s, data_aug_t)

            # Update graph
            # print('\n start adding a seed nodes')
            if iteration == 0:
                seed_list1, seed_list2, S, adj2, S_emb = self.AddSeeds_ver2_init(
                    embedding1, embedding2, embedding_aug1, embedding_aug2, index, columns, seed_list1, seed_list2,
                    iteration)
            else:
                seed_list1, seed_list2, S, adj2 = self.AddSeeds_ver2(
                    S_emb, embedding1, embedding2, embedding_aug1, embedding_aug2, index, columns, seed_list1,
    ...
    def AddSeeds_ver2(self, S_emb, embedding1, embedding2, embedding_aug1, embedding_aug2, index, columns, seed_list1,
                      seed_list2, iteration):
        S_fin = S_emb
    ...
    def AddSeeds_ver2_init(self, embedding1, embedding2, embedding_aug1, embedding_aug2, index, columns, seed_list1,
                           seed_list2, iteration):
